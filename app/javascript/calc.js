function calc(){
  ...
  const group_price_one = document.getElementById("group-price-one");                 // グループ１の金額(ID取得)
  ...
  const group_price_two = document.getElementById("group-price-two");                 // グループ2の金額(ID取得)
  ...
  const group_price_three = document.getElementById("group-price-three");             // グループ3の金額(ID取得)
  ...
  total_payment.addEventListener('keyup', () => {
    ...
    let price_two_value = group_price_two.value;              // グループ2の金額
    let people_three_value = group_people_three.value;        // グループ3の人数
    let price_three_value = group_price_three.value;          // グループ3の金額
    ...
    group_ratio_one.textContent = 100 - ratio_two_value - ratio_three_value;                          // グループ1の比率(表示)
  ...
  group_ratio_two.addEventListener('keyup', () => {
    ...
    if (people_two_value) {
      ...
      group_ratio_one.textContent = 100 - ratio_three_value - ratio_two_value;                          // グループ1の比率(表示)
